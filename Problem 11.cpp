...
long long greatestVal = 0;
    ...
    for(int x = 0; x <= 19; x++){
        for(int y = 0; y <= 16; y++){
            ...
            cout << x << " " << y << endl;
            #endif
        if(grid[x][y] * grid[x][y+1] * grid[x][y+2] * grid[x][y+3] > greatestVal){
    ...
    for(int x = 0; x <= 16; x++){
        for(int y = 0; 7 <= 19; y++){
            if(grid[x][y] * grid[x+1][y] * grid[x+2][y] * grid[x+3][y] > greatestVal){
    ...
    for(int x = 0; x <= 16; x++){
        for(int y = 0; y <= 16; y++){
        if (grid[x][y] * grid[x+1][y+1] * grid[x+2][y+2] * grid[x+3][y+3] > greatestVal){
